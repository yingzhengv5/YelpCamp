...
const seedDB = async () => {
    ...
    for (let i = 0; i < 200; i++) {
        ...
        const camp = new Campground({
            // Your user ID
            author: '66725742866c8513cdd5dcb7',
            ...
            description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit perferendis dolor expedita aspernatur perspiciatis! Magnam, fuga explicabo sint, ex consectetur vel inventore officiis tempore deleniti animi esse repellendus totam ipsam!',
            price,
            geometry: {
                type: 'Point',
                coordinates: [ 
